...
@section('content')
    ...
    <div class="col-md-12">
        <form id="TypeValidation" class="form-horizontal"
              action="{{route('news_and_events.update',$news_and_event->id)}}" method="post"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" maxlength="100" name="title"
                                           value="{{$news_and_event->title}}" required="true"/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="datepicker" name="date"
                                           value="{{$news_and_event->date}}" autocomplete="off"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="location"
                                           value="{{$news_and_event->location}}" required="true">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Start Time*" class="form-control timepicker"
                                           value="{{$news_and_event->start}}" id="timepicker1" name="start"
                                           required="true">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group ">
                                    ...
                                    <input type="text" placeholder="End Time*" class="form-control timepicker"
                                           value="{{$news_and_event->end}}" id="timepicker2" name="end" required="true">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" value="{{$news_and_event->no_of_days}}"
                                           class="form-control" name="no_of_days" required="true">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                >
                                    ...
                                    <option value="holiday" @if($news_and_event->event=='holiday') selected @endif>
                                        Holiday
                                    </option>
                                    <option value="activities"
                                            @if($news_and_event->event=='activities') selected @endif>Activities
                                    </option>
                                    <option value="regular" @if($news_and_event->event=='regular') selected @endif>
                                        Regular
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    ...
                                    <div class="fileinput-new img-thumbnail"
                                        ...
                                        @if($news_and_event->featured_image!=null)
                                            <img src="{{url('/').Storage::url($news_and_event->featured_image)}}"/>
                                        @else<img
                        ...
                        <div class="col-sm-10">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control my-editor"
                                          required>{{$news_and_event->description}}</textarea>
                                <script>
                                    var editor_config = {
                                        path_absolute: "{{url('/')}}/",
