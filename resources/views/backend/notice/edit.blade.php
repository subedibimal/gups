            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item "><a href="{{url('admin/notice')}}">Notice</a></li>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title"
                                           value="{{$notice->title ?? null}}" required>
                                </div>
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <textarea id="my-editor1" name="description" required
                                              class="form-control">{!!$notice->description ?? 'Your Text Here'!!}</textarea>
